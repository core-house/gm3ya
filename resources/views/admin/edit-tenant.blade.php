        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('admin.update-tenant', $tenant) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $tenant->name) }}" required autofocus>
                </div>

                <div class="form-group">
                    <label for="domain">Domain (اختياري)</label>
                    <input type="text" id="domain" name="domain" value="{{ old('domain', $tenant->domain) }}" placeholder="example.com">
                </div>

                <div class="form-group">
                    <label for="subdomain">Subdomain (اختياري)</label>
                    <input type="text" id="subdomain" name="subdomain" value="{{ old('subdomain', $tenant->subdomain) }}" placeholder="subdomain">
                </div>
                ...
                <div style="margin-top: 30px;">
                    <button type="submit" class="btn btn-primary">تحديث Tenant</button>
